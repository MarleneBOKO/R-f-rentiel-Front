<template><!-- <v-card color="white" class="rounded-xl " flat>
                    <v-row>
                      <v-col cols="12" sm="12">
                        <v-img
            ...
            <v-card-title class="ml-0 pl-0">
              ...
              <v-col cols="12" sm="6" md="4">
                <v-text-field label="Date opération" color="#3A1C71" filled disabled background-color="#4DD0E1"
                  type="date" v-model="adnewObject.transactionDate"></v-text-field>
                                  </v-col>
                                  <!-- <v-col cols="12" sm="6" md="4">
                                      <v-select
                                  ...
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Date depot facture " color="#3A1C71" filled disabled background-color="#4DD0E1"
                                      type="date" v-model="adnewObject.invoiceDepositDate"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="4">
              ...
              <v-col cols="12" sm="6" md="4">
                <v-text-field label="Date paiement facture" color="#3A1C71" filled type="date" disabled
                  background-color="#4DD0E1" v-model="adnewObject.invoicePaymentDate"></v-text-field>
                                  </v-col>
              <!-- <v-col cols="12" sm="6" md="4">
                  <v-text-field
                    label="Prime"
              ...
              <v-col cols="12" sm="6" md="12">
                <v-text-field label="Observation" color="#3A1C71" filled disabled background-color="#4DD0E1"
                  v-model="adnewObject.observation"></v-text-field>
                                ...
                                <v-row>
                                  ...
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Nom déposant" color="#3A1C71" filled
                                      v-model="adnewObject.applicantName"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="téléphone déposant" color="#3A1C71" filled
                                      v-model="adnewObject.callingPhone"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Date depot" color="#3A1C71" filled @change="valueChange()" type="date"
                                      v-model="adnewObject.filingDate"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Durée prévionnelle" color="#3A1C71" filled type="number"
                                      v-model="adnewObject.repairTime"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Date de retrait" color="#3A1C71" filled @change="valueChange()" type="date"
                                  ...
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Montant achat pièce" color="#3A1C71" filled disable @change="valueChange()"
                                      type="number" v-model="adnewObject.partPurchaseAmount"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Travaux technique" color="#3A1C71" filled @change="valueChange()" type="number"
                                      v-model="adnewObject.workForce"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                  ...
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Montant du devis ttc" color="#3A1C71" filled disabled background-color="#4DD0E1"
                                      type="number" v-model="adnewObject.ttcAmount"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Montant du dévis accepté par NSIA" color="#3A1C71" filled disabled
                                      background-color="#4DD0E1" type="number" v-model="adnewObject.ipacAmount"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="4">
                <v-text-field label="Avance reçue" color="#3A1C71" filled disabled background-color="#4DD0E1"
                  type="number" v-model="adnewObject.advanceReceived"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="4">
                <v-text-field label="Reste à payer" color="#3A1C71" filled disabled background-color="#4DD0E1"
                  type="number" v-model="adnewObject.leftToPay"></v-text-field>
                                  ...
                                  <v-col cols="12" sm="6" md="4">
                                    <v-text-field label="Règlemnet garagiste" color="#3A1C71" filled disabled background-color="#4DD0E1"
                                      type="number" v-model="adnewObject.mechanicSettlement"></v-text-field>
                                  </v-col>
                                </v-row>
                              </v-card-text>
                              <v-card-actions>
                  ...
                  <!-- <v-tooltip bottom color="#3A1C71">
                      ...
                      <span>Fiche de prise en charge</span>
                    </v-tooltip> -->
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      {
        text: "Montant du dévis accepté par NSIA ",
        width: "250px",
        // divider: true,
        // class: "deep-purple darken-4 white--text",
        align: "start",
  ...
  methods: {
    ...
    async initFiles() {
      this.loading = true;
      try {
        await this.getRepairPerso({
          // mechaId: "6351da370d82140016024ab2",
    ...
    async addPvFormModal() {
      this.loading = true;
      let word = "";
      // this.startItem = this.adnewObject.agreement;
      ...
      try {
        const schema = {
          ...
          amountEVAT: parseInt(this.adnewObject.amountEVAT),
          VAT: this.adnewObject.VAT,
