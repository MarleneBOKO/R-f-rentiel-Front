<template>
  ...
  <v-container fluid>
      ...
      <v-expansion-panels flat style="border: 1px solid #3A1C71;margin-bottom:10px">
        <v-expansion-panel class="elevation-0">
          ...
          <v-expansion-panel-content>
            <v-row>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date opération début" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="transactionDateStart" type="date" filled dense outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date opération fin" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="transactionDateEnd" type="date" filled dense outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date dépôt facture début" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="invoiceDepositDateStart" type="date" filled dense outlined
                  flat background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date dépôt facture fin" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="invoiceDepositDateEnd" type="date" filled dense outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date payement facture début" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="invoicePaymentDateStart" type="date" filled dense outlined
                  flat background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date payement facture fin" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="invoicePaymentDateEnd" type="date" filled dense outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
              ...
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Nom victime" class="pt-5 pa-2" filled
                  prepend-inner-icon="mdi-magnify" dense v-model="sinisterVictimName" outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-select :items="garagisteNameList" filled prepend-inner-icon="mdi-magnify" dense class="pt-5 pa-2"
                  outlined flat rounded label="Garagiste" color="#3A1C71" v-model="mechanic"></v-select>
              </v-col>
            </v-row>
            <v-card-actions>
              <v-spacer></v-spacer>
              ...
              <v-btn color="error" outlined pill rounded @click="getStatRecap()" target="_blank">
      ...
      <v-row justify="center">
        <v-dialog v-model="addFile" max-width="1000px">
          <v-card style="border-left: 10px solid #3A1C71">
            <v-card-title>
              <span class="text-h5 mb-5 mt-5" style="color:#3A1C71;">Information du dossier</span>
            </v-card-title>
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" sm="6" md="4">
                  <v-text-field disabled background-color="#4DD0E1" label="Nom agent" color="#3A1C71"
                    v-model="adnewObject.agentName" filled></v-text-field>
                </v-col>
              </v-row>
              <v-card-title class="ml-0 pl-0">
                <span class="text-h5 mb-5 ml-0 mt-5" style="color:#3A1C71;">Gestion du dossier</span>
              </v-card-title>

              <v-row>
                <v-col cols="12" sm="6" md="4">
                  <v-select :items="garagisteNameList" label="garagiste" color="#3A1C71" filled
                    v-model="adnewObject.mechanic"></v-select>
                </v-col>

                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Date opération" color="#3A1C71" filled type="date"
                    v-model="adnewObject.transactionDate"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-select label="Constat amiable" :items="Decision" color="#3A1C71" filled
                    v-model="adnewObject.jointReport"></v-select>
                </v-col>

                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Date réception" color="#3A1C71" filled type="date"
                    v-model="adnewObject.receivedDate"></v-text-field>
                </v-col>

                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Date depot facture " color="#3A1C71" filled type="date"
                    v-model="adnewObject.invoiceDepositDate"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Delai paiement facture" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    v-model="adnewObject.invoicePaymentDeadline"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Date paiement facture" color="#3A1C71" filled type="date"
                    v-model="adnewObject.invoicePaymentDate"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Prime" color="#3A1C71" filled type="number"
                    v-model="adnewObject.prime"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-select label="Recours" color="#3A1C71" filled :items="Decision"
                    v-model="adnewObject.appeal"></v-select>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-select label="vehicule de remplacement" color="#3A1C71" filled :items="Decision"
                    v-model="adnewObject.replacementVehicle"></v-select>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-select label="Expert" :items="enquetteurNameList" color="#3A1C71" filled
                    v-model="adnewObject.expert"></v-select>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-select :items="TrDomage" label="Tr dommage" color="#3A1C71" filled
                    v-model="adnewObject.trDamage"></v-select>
                </v-col>
              ...
              <v-card-title class="ml-0 pl-0">
                <span class="text-h5 mb-5 ml-0 mt-5" style="color:#3A1C71;">Suivi de réparation</span>
              </v-card-title>

              <v-row>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Fiche de reception" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    v-model="adnewObject.receptionSheet"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Marque véhicule" color="#3A1C71" filled
                    v-model="adnewObject.vehicleBrand"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Nom déposant" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    v-model="adnewObject.applicantName"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="téléphone déposant" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    v-model="adnewObject.callingPhone"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Date depot" color="#3A1C71" filled disabled background-color="#4DD0E1" type="date"
                    v-model="adnewObject.filingDate"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Durée prévionnelle" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    type="number" v-model="adnewObject.repairTime"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Date de retrait" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    type="date" v-model="adnewObject.withdrawalDate"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Durée des travaux" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    type="number" v-model="adnewObject.workDuration"></v-text-field>
                </v-col>

                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Montant achat pièce" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    type="number" v-model="adnewObject.partPurchaseAmount"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Main doeuvre" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    type="number" v-model="adnewObject.workForce"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Montant devis proforma" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    type="number" v-model="adnewObject.proformaQuoteAmount"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Montant htva" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    type="number" v-model="adnewObject.amountEVAT"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Tva" color="#3A1C71" filled disabled background-color="#4DD0E1" type="number"
                    v-model="adnewObject.VAT"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Montantdu devis ttc" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    type="number" v-model="adnewObject.ttcAmount"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Montant de la facture a payer et accepter par compagnie" color="#3A1C71" filled
                    type="number" v-model="adnewObject.ipacAmount"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Avance reçue" color="#3A1C71" filled type="number"
                    v-model="adnewObject.advanceReceived"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Reste à payer" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    type="number" v-model="adnewObject.leftToPay"></v-text-field>
                </v-col>
                <!-- <v-col cols="12" sm="6" md="4">
                  <v-text-field
                    label="Bonus-malus"
                ...
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Règlemnet garagiste" color="#3A1C71" filled type="number"
                    v-model="adnewObject.mechanicSettlement"></v-text-field>
                </v-col>
              </v-row>
            </v-card-text>
            <v-card-actions>
        ...
        <v-dialog v-model="receptionFiche" max-width="1000px">
          <v-card style="border-left: 10px solid #3A1C71">
            <v-row>
              <v-card-title>
                <span class="text-h5 mb-5 mt-5 ml-5" style="color:#3A1C71;">Fiche de réception et appréciation</span>
              </v-card-title>
              <v-spacer></v-spacer>
              <v-btn class="mt-8 mr-9" color="success darken-1" outlined @click="genereteDocFile(adnewObject.repaireId)">
            ...
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Immatriculation" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    v-model="adnewObject.vehicleRegistration"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Marque" v-model="adnewObject.vehicleBrand" color="#3A1C71" disabled
                    background-color="#4DD0E1" filled></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Date d'accident" disabled type="date" background-color="#4DD0E1"
                    v-model="adnewObject.sinisterDate" color="#3A1C71" filled></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Type de garantie" disabled background-color="#4DD0E1" color="#3A1C71" filled
                    v-model="adnewObject.trDamage"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field disabled background-color="#4DD0E1" label="Date remise de l'objet" color="#3A1C71" filled
                    type="date" v-model="adnewObject.filingDate"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Nom du déposant" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    v-model="adnewObject.applicantName"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Nom du prestaitaire" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    v-model="adnewObject.mechanic"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Delai de réparation" color="#3A1C71" filled disabled background-color="#4DD0E1"
                    v-model="adnewObject.workDuration"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Date reception par client" color="#3A1C71" filled disabled
                    background-color="#4DD0E1" v-model="adnewObject.withdrawalDate"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-select label="Choix de règlement" :items="['REPARATION', 'INDEMNISATION']"
                    v-model="adnewObject.reglementChoose" color="#3A1C71" filled></v-select>
                </v-col>
                <v-col cols="12" sm="6" md="6">
                  <v-text-field label="Accord" color="#3A1C71" v-model="adnewObject.agreement" filled></v-text-field>
                </v-col>

                <v-col cols="12" sm="6" md="6">
                  <v-text-field background-color="#ffd670" label="Préjudice matériel" color="#3A1C71" filled
                    v-model="adnewObject.materialIndermnity"></v-text-field>
                </v-col>

                <v-col cols="12" sm="6" md="6">
                  <v-text-field background-color="#ffd670" label="Pièces a récupérer" color="#3A1C71" filled
                    v-model="adnewObject.piecesToRecover"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="6">
                  <v-text-field background-color="#ffd670" label="Accéssoires" color="#3A1C71" filled
                    v-model="adnewObject.accessories"></v-text-field>
                </v-col>
              </v-row>
              <v-card-title class="ml-0 pl-0">
                <span class="text-h5 mb-5 ml-0 mt-5" style="color:#3A1C71;">Note / Appréciation</span>
              </v-card-title>

              <v-row>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Accueil" color="#3A1C71" filled type="Number" min="1" max="5" counter="1"
                    v-model="adnewObject.receptionAppreciation"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Delai de réparation" color="#3A1C71" filled type="number" min="1" max="5"
                    counter="1" v-model="adnewObject.repairTimeAppreciation"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Qualité de travil" color="#3A1C71" filled type="number" min="1" max="5" counter="1"
                    v-model="adnewObject.workQualityAppreciation"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="3">
                  <v-text-field label="Accessoires" color="#3A1C71" filled type="number" min="1" max="3" counter="1"
                    v-model="adnewObject.accessoriesAppreciation"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="6">
                  <v-text-field label="Autres" color="#3A1C71" filled type="number" min="1" max="2" counter="1"
                    v-model="adnewObject.others"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="6">
                  <v-text-field label="Note NSIA" color="#3A1C71" filled type="number" min="1" max="20" counter="2"
                    v-model="adnewObject.totalAppreciation"></v-text-field>
                </v-col>
              </v-row>
            </v-card-text>
            <v-card-actions>
    ...
    <template>
      <div>
        <v-data-table :headers="headers" :items="repaire" :items-per-page="10" class="elevation-0" background-color="red"
    ...
    async initFiles() {
      ...
      try {
        await this.getRepair({
          ...
          invoiceDepositDateStart: this.invoiceDepositDateStart,
          invoiceDepositDateEnd: this.invoiceDepositDateEnd,
          invoicePaymentDateStart: this.invoicePaymentDateStart,
          invoicePaymentDateEnd: this.invoicePaymentDateEnd,
          sinisterNumber: this.sinisterNumber,
          sinisterVictimName: this.sinisterVictimName,
