            ...
            <v-row>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date d'arrivée début" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="receptionDateStart" filled dense outlined flat type="date"
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date d'arrivée fin" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="receptionDateEnd" filled dense outlined flat type="date"
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date de traitement début" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="treatmentDateStart" filled dense type="date" outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date de traitement fin" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="treatmentDateEnd" filled dense type="date" outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="4">
              ...
              <v-col cols="12" md="3">
                <v-select label="Nom victime" outlined class="pt-5 pa-2" filled prepend-inner-icon="mdi-magnify" dense
                  flat background-color="grey lighten-4" rounded color="#3A1C71" v-model="sinisterVictimName"
