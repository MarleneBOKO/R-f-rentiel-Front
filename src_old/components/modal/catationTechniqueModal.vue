<template>
  ...
  <v-card style="border-top: 10px solid #061a40">
    <v-card-title>
      <span class="text-h6">Adresser une demande à la Direction Technique</span>
    </v-card-title>
    <v-card-text>
      <v-container>
        <v-row>
    ...
    <v-card-actions>
      ...
      <v-btn
        ...
        :loading="loading"
        @click="saveQuotingRequest"
      >
        Adresser Demande cotation
      </v-btn>
    </v-card-actions>
  </v-card>
</template>
