      ...
      <v-expansion-panels flat style="border: 1px solid #3A1C71;margin-bottom:10px">
        <v-expansion-panel class="elevation-0">
          ...
          <v-expansion-panel-content>
            <v-row>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date mission début" class="pt-5 pa-2"
              ...
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date mission fin" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="requestDateEnd" type="date" filled dense outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date compte rendu début" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="reportArrivalDateStart" type="date" filled dense outlined
                  flat background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date compte rendu fin" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="reportArrivalDateEnd" type="date" filled dense outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date prochine audience début" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="nextHearingDateStart" type="date" filled dense outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
                <v-text-field color="#3A1C71" label="Date prochine audience fin" class="pt-5 pa-2"
                  prepend-inner-icon="mdi-magnify" v-model="nextHearingDateEnd" type="date" filled dense outlined flat
                  background-color="grey lighten-4" rounded></v-text-field>
              </v-col>
              <v-col cols="12" md="3">
              ...
              <v-col cols="12" md="3">
                <v-select :items="enquetteurNameList" filled prepend-inner-icon="mdi-magnify" dense class="pt-5 pa-2"
                  outlined flat rounded label="Avocat" color="#3A1C71" v-model="lawyer"></v-select>
              </v-col>
            </v-row>
            <v-card-actions>
              <v-spacer></v-spacer>
          ...
          <v-card style="border-left: 10px solid #3A1C71">
            ...
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" sm="6" md="3">
                  <v-select :items="StatusIiems" filled
                   color="#3A1C71" label="Statut"  v-model="adnewObject.status"></v-select>
                </v-col>
                <v-col cols="12" sm="6" md="6">
    ...
    async initFiles() {
      ...
      try {
        await this.getLitigation({
          ...
          reportArrivalDateStart: this.reportArrivalDateStart,
          reportArrivalDateEnd: this.reportArrivalDateEnd,
          nextHearingDateStart: this.nextHearingDateStart,
          nextHearingDateEnd: this.nextHearingDateEnd,
