...
export const repaireRecap = () => {
    // console.log(schema.email);
    return new Promise((resolve, reject) => {
        axios.post(`/repair/capture-manuel-exercices`, { year2023 : true}).then(
            (res) => {
        ...
        axios.post(`/beneficiary`, schema).then(
            (res) => {
                ...
                if (schema.receptionServiceSendDate) {
                    axios.post(`/check`, {
                        studyOffer: schema.studyOffer,
                        beneficiary: res.data.data._id,
...
export const addFilendemnity = ({ schema }) => {
    ...
    return new Promise((resolve, reject) => {
        axios
            // .post("https://172.17.192.9:3000/convertir", schema)
            .post("https://127.0.0.1:5000/convertir", schema)
            console.lo("ok")
            .then(
                (res) => {
                    resolve(res.data);
