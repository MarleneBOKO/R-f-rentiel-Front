...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Date de demande Bon", width: "200px", value: "requestDateFr" },
        {
          text: "Date réception",
          width: "200px",
          value: "couponReceptionDateFr",
        },
        { text: "Montant", width: "200px", value: "amount" },
      ...
      workSheetName: "Rapport Statistique BON",
      nombre: "bon",
      users: [],
    };
  },
  ...
  computed: {
    ...mapGetters(["statbon", "Companies", "statFileBon"]),
  },
  watch: {
    Companies() {
  ...
  methods: {
    ...
    ...mapActions(["getStateBon", "getCompanies"]),
    async initStatBon() {
      this.loading = true;
      try {
        await this.getStateBon({
...
<template>
  <v-container fluid>
    ...
    >
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Listing des Bon</v-toolbar-title>
            ...
            <v-expansion-panel class="elevation-0">
              ...
              <v-expansion-panel-content>
                <v-row>
                  ...
                  <v-text-field
                    color="#061a40"
                    label="Date de demande Bon début ..."
                    class="pt-5 pa-2"
                    filled
                    v-model="startDate"
                    prepend-inner-icon="mdi-magnify"
