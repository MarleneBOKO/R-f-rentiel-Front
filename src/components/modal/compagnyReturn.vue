<template>
  <v-card style="border-top: 10px solid #061a40">
    <template>
      <v-data-table
        :headers="companyReturnHeaders"
        :items="CompanyReturns.docs"
        class="elevation-1"
      >
        <template v-slot:top>
          <v-toolbar flat>
            <v-toolbar-title>Listing des retours compagnies</v-toolbar-title>
            <v-divider class="mx-4" inset vertical></v-divider>
            <v-spacer></v-spacer>
            <v-dialog v-model="customerReturnDialog" max-width="500px">
              <template v-slot:activator="{ on, attrs }">
                ...
                <v-btn
                  ...
                  @click="importData()"
                >
                  <v-icon size="30" class="mr-8" color="#1D6F42" left>
                    mdi-microsoft-excel
                  </v-icon>
                  Imprimer en tableau EXCEL
                </v-btn>
              </template>
              ...
              <v-card style="border-top: 10px solid #061a40">
                ...
                <v-card-text>
                  <v-container>
                    <v-row>
                      <!-- <v-col cols="6">
                            <v-select
                              :items="quotingModal.companies"
                              v-model="companyReturnModal.company"
                              label="Choix de la compagnie"
                            ></v-select>
                          </v-col> -->
                      <v-col cols="6">
                        <v-select
                      ...
                      <v-col cols="6">
                        <v-text-field
                          v-model="companyReturnModal.accessory"
                          type="number"
                      ...
                      <v-col cols="6">
                        <v-text-field
                          v-model="companyReturnModal.netPrime"
                          type="number"
                          label="Prime Nette"
                        ></v-text-field>
                      </v-col>
                      <v-col cols="6">
                        <v-text-field
                          v-model="companyReturnModal.tax"
                          type="number"
                          label="TAXE"
                        ></v-text-field>
                      </v-col>
                      <v-col cols="6">
                        <v-text-field
                          color="#061a40"
                          v-model="companyReturnModal.TACAVA"
                          label="FGA"
                        ></v-text-field>
                      </v-col>
                      <v-col cols="6">
                        <v-text-field
                          color="#061a40"
                          v-model="companyReturnModal.TVA"
                          label="CEDEAO"
                        ></v-text-field>
                      </v-col>
                      <v-col cols="6">
                        <v-text-field
                          v-model="companyReturnModal.TTCPrime"
                          type="number"
                          label="Prime TTC"
                        ></v-text-field>
                      </v-col>
                      <v-col cols="6">
                        <v-text-field
                          v-model="companyReturnModal.returnDate"
                          type="date"
                      ...
                      <v-col cols="12">
                        <v-textarea
                          v-model="companyReturnModal.observation"
                          outlined
                          name="input-7-4"
                          label="Observation"
                        ></v-textarea>
                ...
                <v-card-actions>
                  ...
                  <v-btn
                    ...
                    text
                    @click="closeCompanyReturn"
                  >
                    Fermer
                  </v-btn>
                  <v-btn color="success darken-1" @click="saveCompanyReturn">
                    Enregistrer
                  </v-btn>
                </v-card-actions>
              </v-card>
        ...
        <template v-slot:item.actions="{ item }">
          <v-icon small class="mr-2" @click="editCompanyReturn(item)">
            mdi-pencil
          </v-icon>
        </template>
        <template v-slot:item.company="{ item }">
          {{ defaultMethods.getItemName(Companies.docs, item.company.name) }}
        </template>
      </v-data-table>
    </template>
  </v-card>
...
export default {
  ...
  data() {
    return {
      ...
      companyReturnHeaders: [
        ...
        { text: "TAXE", value: "tax" },
        { text: "FGA", value: "TACAVA" },
        { text: "CEDEAO", value: "TVA" },
  ...
  methods: {
    ...
    editCompanyReturn(item) {
      ...
      this.companyReturnModal.TACAVA = item.TACAVA;
      this.companyReturnModal.TVA = item.TVA;
      this.companyReturnModal.returnDate = item.returnDate;
      this.companyReturnModal.observation = item.observation;
    ...
    async saveCompanyReturn() {
      ...
      try {
        ...
        const schema = {
          ...
          observation: this.companyReturnModal.observation,
          ...
          TACAVA: this.companyReturnModal.TACAVA,
          TVA: this.companyReturnModal.TVA,
