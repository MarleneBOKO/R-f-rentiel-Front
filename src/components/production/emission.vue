<template>
  <v-container fluid>
    ...
    >
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Listing des emission</v-toolbar-title>
              ...
              <v-expansion-panel-content>
                <v-row>
                  ...
                  <v-col cols="12" sm="6" md="3">
                    <v-text-field
                      color="#061a40"
                      label="Date mise en place contrat début"
                      class="pt-5 pa-2"
                      filled
                      prepend-inner-icon="mdi-magnify"
                      dense
                  ...
                  <v-col cols="12" sm="6" md="3">
                    <v-text-field
                      color="#061a40"
                      label="Date  mise en place contrat fin"
                      class="pt-5 pa-2"
                      filled
                      prepend-inner-icon="mdi-magnify"
                      dense
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Date Enregistrement", width: "200px", value: "paymentDate" },
      ...
      workSheetName: "Rapport Statistique d'emmission",
      nombre: "emission",
      users: [],
    };
  },
  mounted() {
    this.initStatContrat();
  },
  computed: {
    ...mapGetters(["statContrat", "Companies", "Products", "statFileEmission"]),
  },
  watch: {
    statCall() {},
    Companies() {
  ...
  methods: {
    ...
    ...mapActions(["getStateContrat", "getCompanies", "getProducts"]),
    async initStatContrat() {
      this.loading = true;
      try {
        await this.getStateContrat({
