<template>
        ...
        <v-expansion-panels flat style="border: 1px solid #3A1C71;margin-bottom:10px">
          <v-expansion-panel class="elevation-0">
            ...
            <v-expansion-panel-content>
              <v-row>
                       <v-col cols="12" md="3">
                  <v-autocomplete :items="brokerNameList" filled prepend-inner-icon="mdi-magnify" dense class="pt-5 pa-2" outlined
                    flat rounded label="Point de vente" color="#3A1C71" v-model="broker"></v-autocomplete>
                </v-col>
                <v-col cols="12" md="3">
                  <v-autocomplete :items="StatusIiems" filled prepend-inner-icon="mdi-magnify" dense class="pt-5 pa-2" outlined
                    flat rounded label="Statut" color="#3A1C71" v-model="inventoryStatus"></v-autocomplete>
                </v-col>
                <v-col cols="12" md="3">
                  <v-autocomplete :items="agencyrNameList" filled prepend-inner-icon="mdi-magnify" dense class="pt-5 pa-2" outlined
                    flat rounded label="Compagnie" color="#3A1C71" v-model="thirdPartyCompany"></v-autocomplete>
                </v-col>
                <v-col cols="12" md="3">
                  <v-autocomplete :items="productNameList" filled prepend-inner-icon="mdi-magnify" dense class="pt-5 pa-2" outlined
                    flat rounded label="Produit" color="#3A1C71" v-model="product"></v-autocomplete>
                </v-col>
                <v-col cols="12" md="3">
                ...
                <v-col cols="12" md="3">
                  <v-text-field color="#3A1C71" label="Date déclaration début" class="pt-5 pa-2"
                    prepend-inner-icon="mdi-magnify" v-model="declarationDateStart" type="date" filled dense outlined flat
                    background-color="grey lighten-4" rounded></v-text-field>
                </v-col>
                <v-col cols="12" md="3">
                  <v-text-field color="#3A1C71" label="Date déclaration fin" class="pt-5 pa-2"
                    prepend-inner-icon="mdi-magnify" v-model="declarationDateEnd" type="date" filled dense outlined flat
                    background-color="grey lighten-4" rounded></v-text-field>
                </v-col>
                <v-col cols="12" md="3">
                  <v-text-field color="#3A1C71" label="Date d'ouverture début" class="pt-5 pa-2"
                    prepend-inner-icon="mdi-magnify" v-model="openingDateStart" type="date" filled dense outlined flat
                    background-color="grey lighten-4" rounded></v-text-field>
                </v-col>
                <v-col cols="12" md="3">
                  <v-text-field color="#3A1C71" label="Date d'ouverture fin" class="pt-5 pa-2"
                    prepend-inner-icon="mdi-magnify" v-model="openingDateEnd" type="date" filled dense outlined flat
                    background-color="grey lighten-4" rounded></v-text-field>
                </v-col>
                <!-- <v-col cols="12" md="3">
              ...
              <v-card-actions>
                ...
                <v-btn color="#1D6F42" outlined pill rounded  @click="openLinks" >
                ...
                <v-data-table :headers="headersExcel" :items="indemnityData" :page.sync="pages" :items-per-page="5"
                  ...
                  <template v-slot:item="{ item }">
                        <tr class=" miniTableRow green-bg">
                          ...
                          <td>{{ item.thirdPartyRegistration }}</td>
                          <td>{{ item.thirdPartyCompany }}</td>
  ...
  export default {
    ...
    watch: {
      ...
      brokerListe() {
        this.brokerNameList = defaultMethods.getNameList(this.brokerListe);
      },
      userListe() {
    ...
    methods: {
      ...
      openLinks() {
    const win1 = window.open(this.statFile, '_blank');
    const win2 = window.open(this.statFileRecap, '_blank');
    console.log(win2)
    win1.focus(); // Facultatif : pour mettre le focus sur le premier onglet ouvert
          ...
          await this.getStatFiles({
           broker: defaultMethods.getItemId(
            ...
            thirdPartyCompany: defaultMethods.getItemId(
              this.agency,
              this.thirdPartyCompany
            ),
            inventoryStatus: this.inventoryStatus,
            sinisterDateStart: this.sinisterDateStart,
            sinisterDateDateEnd: this.sinisterDateDateEnd,
            declarationDateStart: this.declarationDateStart,
            declarationDateEnd: this.declarationDateEnd,
            openingDateStart: this.openingDateStart,
            openingDateEnd: this.openingDateEnd,
          });
      ...
      valueChange() {
        ...
        case "FMP":
          this.garantedSubDataSeed = ["FMP", "ITT", "INVALIDITE", "DECES"];
          break;
        case "ITT":
          this.garantedSubDataSeed = ["FMP", "ITT", "INVALIDITE", "DECES"];
          break;
        ...
        case "Tempètes Ouragan Cyclone":
          this.garantedSubDataSeed = ["Tempètes Ouragan Cyclone"];
          break;
        case "Dommage aux appareils électriques":
          this.garantedSubDataSeed = ["Dommage aux appareils électriques"];
          break;
        case "Frais de déblais & de démolition":
          this.garantedSubDataSeed = ["Frais de déblais & de démolition"];
          break;
        ...
        case "Travel Assurance":
          this.garantedSubDataSeed = ["Travel Assurance", "Assistance"];
          break;
        case "Assistance":
          this.garantedSubDataSeed = ["Travel Assurance", "Assistance"];
          break;
