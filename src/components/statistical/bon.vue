<template>
      ...
      <template>
        <v-row class="  ml-4 mb-4 mt-5" justify="start">
          <h4 class="text-h4 pageTitle ">
           Statistiques bons de prise en charge
          </h4>
        </v-row>
  ...
  export default {
    ...
    data: () => ({
      ...
      Decision: ["Oui", "Non"],
      StatusIiems: ["Toute la base","Bon en instance", "Bons émis","Bons non payés", "Bons payés"],
