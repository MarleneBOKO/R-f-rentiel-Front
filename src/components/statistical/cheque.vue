  ...
  <v-container fluid>
    ...
    <template>
      <v-row class="ml-4 mb-4 mt-5" justify="start">
        <h4 class="text-h4 pageTitle">Statistiques chèque</h4>
      </v-row>
              ...
              <v-row>
                ...
                <v-col cols="12" sm="6" md="4">
                  <v-text-field
                    ...
                    v-model="adnewObject.beneficiaryType"
                    color="#3A1C71"
                    disabled
                    background-color="#4DD0E1"
                    filled
                ...
                <v-col cols="12" sm="6" md="4">
                  <v-text-field
                    ...
                    filled
                    v-if="showText"
                    v-model="adnewObject.beneficiaryName"
                  ></v-text-field>
                  <v-select
                    v-if="showSelect"
                    label="Nom bénéficiaire"
                ...
                <v-col cols="12" sm="6" md="4">
                  <v-text-field
                    ...
                    color="#3A1C71"
                    v-model="adnewObject.beneficiaryContact"
                    filled
                  ></v-text-field>
                </v-col>
                ...
                <v-col cols="12" sm="6" md="4">
                  <v-text-field
                    ...
                    color="#3A1C71"
                    filled
                    v-model="adnewObject.checkNumber"
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field
                ...
                <v-col cols="12" sm="6" md="4">
                  <v-text-field
                    ...
                    filled
                    type="date"
                    v-model="adnewObject.checkDate"
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field
                    label="Date réception service accueil"
                    color="#3A1C71"
                    filled
                    type="date"
                    v-model="adnewObject.receptionServiceReceptionDate"
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field
                    label="Date appel bénifiaire"
                    color="#3A1C71"
                    filled
                    type="date"
                    v-model="adnewObject.beneficiaryCallDate"
                  ></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="6">
                  <v-text-field
                ...
                <v-col cols="12" sm="6" md="6">
                  <v-text-field
                    label="Date retour quittance"
                    color="#3A1C71"
                    filled
                    type="date"
                    v-model="adnewObject.returnReceiptDate"
                  ></v-text-field>
                </v-col>
        ...
        >
          <template v-slot:item="{ item }">
            <tr class="miniTableRow green-bg">
              ...
              <td>
                {{
                  item.beneficiary && item.beneficiary.bank
                    ? item.beneficiary.bank.name
                    : ""
                }}
              </td>
              <td>
...
export default {
  ...
  data: () => ({
    ...
    StatusIiems: [
"Chèques en attente de récèption",
      "Chèques reçus",
      "Chèques appelés",
      "Chèques retirés",
      "Retour quittance",
  ...
  methods: {
    ...
    updateVModel(selectedItems) {
      if (selectedItems === "Chèque reçu") {
        this.statDataSelected = "chequeRecu";
      } else if (selectedItems === "Chèque appelé") {
        this.statDataSelected = "chequeAppele";
      } else if (selectedItems === "Chèque retiré") {
        this.statDataSelected = "chequeRetire";
      } else if (selectedItems === "Chèque retour quittance") {
        this.statDataSelected = "chequeRetourQuittance";
      } else {
        this.statDataSelected = "";
      }
    },
    async initFiles() {
      this.loading = true;
      try {
        await this.getStatCheque({
