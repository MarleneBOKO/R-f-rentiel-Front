...
const actions = {
    ...
    getStatBon({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/voucher?statisticalFilter=${statisticalFilter}&startDate=${startDate}&endDate=${endDate}`
                )
                .then((res) => {
                    // alert(JSON.stringify(res.data.data));
                    commit("SET_BON", res.data.data);
    ...
    getStatPsap({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/sinister/psap-statistical?isInventoryStatistic=${isInventoryStatistic}&inventoryStatues=${JSON.stringify(inventoryStatues)}&startDeclarationDate=${startDeclarationDate}&endDeclarationDate=${endDeclarationDate}&startSinisterDate=${startSinisterDate}&endSinisterDate=${endSinisterDate}`
                )
                .then((res) => {
                    console.log(res)
                    // alert(JSON.stringify(res.data.data));
    ...
    getStatLitigation({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/litigation?status=${status}&startDate=${startDate}&endDate=${endDate}`
                )
                .then((res) => {
                    commit("SET_STATISTIQUE_FILE", res.data.link);
                    // alert(JSON.stringify(res.data.data));
    ...
    getStatCheque({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/check?statisticalFilter=${statisticalFilter}&startDate=${startDate}&endDate=${endDate}`
                )
                .then((res) => {
                    // alert(JSON.stringify(res.data.data));
                    commit("SET_CHEQUE", res.data.data);
    ...
    getRepair({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/repair?statisticalFilter=${statisticalFilter}&startDate=${startDate}&endDate=${endDate}&mechanic=${mechanic}`
                )
                .then((res) => {
                    commit("SET_STATISTIQUE_FILE", res.data.link);
                    // alert(JSON.stringify(res.data.data));
    ...
    getStatOffer({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/studyoffer?statisticalFilter=${statisticalFilter}&startDate=${startDate}&endDate=${endDate}`
                )
                .then((res) => {
                    commit("SET_STATISTIQUE_FILE", res.data.link);
                    // alert(JSON.stringify(res.data.data));
    ...
    getOfferDoc({ commit }, { printed = "", secondSignatureDateStart = "", secondSignatureDateEnd = "", agentName = "" }) {
        ...
        getStatOfferDoc({ commit }, { statisticalFilter = "",
        startDate = "", 
        endDate = "", }) {
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/beneficiary?statisticalFilter=${statisticalFilter}&startDate=${startDate}&endDate=${endDate}`
                )
                .then((res) => {
                    // alert(JSON.stringify(res.data.link));
                    commit("SET_OFFER_DOC_VALUE", res.data.data);
    ...
    getMail({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/mail?statisticalFilter=${statisticalFilter}&startDate=${startDate}&endDate=${endDate}`
                )
                .then((res) => {
                    commit("SET_STATISTIQUE_FILE", res.data.link);
                    // alert(JSON.stringify(res.data.data));
    ...
    getStatVictimeListe({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            // alert("ok")
            axios
                .get(`/complaint?statisticalFilter=${statisticalFilter}&startDate=${startDate}&endDate=${endDate}`)
                .then((res) => {
                    commit("SET_STATISTIQUE_FILE", res.data.link);
                    // alert(JSON.stringify(res.data.data));
                    commit("SET_VICTIME_LIST", res.data.data);
  ...
  return new Promise((resolve, reject) => {
    ...
    getStatPvFiles({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/pv?policeStation=${policeStation}&statisticalFilter=${statisticalFilter}&startDate=${startDate}&endDate=${endDate}`
                )
                .then((res) => {
                    commit("SET_STATISTIQUE_FILE", res.data.link);
                    // alert(JSON.stringify(res));
    ...
    getFiles({ commit }, {
        ...
        return new Promise((resolve, reject) => {
            axios
                .get(
                    `/sinister?declarationDateStartDate=${declarationDateStart}&declarationDateEndDate=${declarationDateEnd}&openingDateStart=${openingDateStart}&openingDateEnd=${openingDateEnd}&product=${product}&inventoryStatus=${inventoryStatus}&sinisterDateStart=${sinisterDateStart}&sinisterDateEnd=${sinisterDateDateEnd}&broker=${broker}&thirdPartyCompany=${thirdPartyCompany}`
                )
                .then((res) => {
    ...
    addFilendemnity({ commit }, form) {
        return new Promise((resolve, reject) => {
            ...
            newInstanceAxios.defaults.baseURL = `http://127.0.0.1:5000`;
            ...
            newInstanceAxios
                ...
                .finally(() => {
                    // newInstanceAxios.defaults.baseURL = "http://172.17.192.9:3087/api/v1";
